...
var Scratchi = function () {
  ...
  _createClass(Scratchi, [{
    ...
    key: "connect",
    value: function connect(apic, username, password, protocol) {
      this.apic = apic;
    ...
    key: "saveClass",
    value: function saveClass(key, value) {
    ...
    key: "getAttribute",
    value: function getAttribute(attribute, mo) {
      var value = mo[attribute];
      console.log(value);
      return value;
    }
  }, {
    key: "getByDn",
    value: function getByDn(dn, callback) {
      console.log("Getting MO", dn);
      var url = this.baseUrl + "/mo/" + dn + ".json?&rsp-prop-include=config-only";
      console.log(url);
      _jquery2.default.ajax({
        url: url,
        type: "GET",
    ...
    key: "getByClass",
    value: function getByClass(cls, callback) {
      console.log("Getting class", cls);
      var url = this.baseUrl + "/class/" + cls + ".json?&rsp-prop-include=config-only";
      console.log(url);
      _jquery2.default.ajax({
        url: url,
        type: "GET",
...
},{"./data.json":2,"jquery":1}],4:[function(require,module,exports){
'use strict';
